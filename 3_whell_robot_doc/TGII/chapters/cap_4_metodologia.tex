...
A tabela X apresenta os custos de cada componente de hardware adquirido para uso exclusivo neste projeto (excluindo,
portanto, equipamentos empregados mas não utilizados apenas nele, como a impressora 3D).

\subsection{Lista geral de componentes e materiais}
\begin{quadro}[htb]
	\caption{Lista de componentes, materiais e seus custos - valores em reais (R\$)}
...
A complexidade do controle de um motor DC apresenta um bom desafio para aplicação dos conceitos e disciplinas do curso de Engenharia de Instrumental, Automação e Robótica.
