...
% Pacotes de citações
\usepackage[alf, backend=biblatex]{abntex2cite}	% Citações padrão ABNT
...
\makeatletter
% define a macro \autorefmany to allow multiple references to be passed to \autoref
\newcommand\autorefmany[1]{\@first@ref#1,@}
...
\def\@next@ref#1,#2{%
   \ifx#2@ e~\ref{#1}\let\@nextref\@gobble% at end: print and+\ref and stop
